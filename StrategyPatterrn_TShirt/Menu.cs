...
namespace StrategyPatterrn_TShirt
{
    class Menu
    {
        ...
        {
            Console.WriteLine("Please select the number correspiding to the desired fabric of the T-Shirt");
            Console.WriteLine("1. WOOL");
            Console.WriteLine("2. COTTON");
            Console.WriteLine("3. POLYESTER");
            Console.WriteLine("4. RAYOL");
        ...
        {
            Console.WriteLine("Please select the number correspiding to the desired Size of the T-Shirt");
        ...
        {
            Console.WriteLine("Please select the number correspiding to the desired Color of the T-Shirt");
        ...
        public void PaymentMethodeMenu()
        {
            Console.WriteLine("Select Payment Methode");
